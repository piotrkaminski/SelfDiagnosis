...
/**
 * Implementation of {@link UserDetailsService} to adjust taking users from
 * local database. Important! There is assumption that email is used as user
 * name.
 * 
 * @author pkaminski
 * 
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    /**
     * Loads user from database using email as a username. Result is used to
     * create {@link User} object used by SpringSecurity framework to perform
     ...
     *             when there is no user with given username
     * @throws DataAccessException
     */
    @Transactional(readOnly = true)
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException, DataAccessException {
        SystemUserEntity userEntity = systemUserDAO.findByEmail(username);
        if (userEntity == null) {
    ...
    /**
     * Convert user entity to user class used by Spring Security.
     * 
     * @param userEntity
     *            database entity
